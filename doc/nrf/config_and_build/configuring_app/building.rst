...
* You can pass ``-vvv`` to ``west build`` to enable :ref:`zephyr:west-building-verbose`.
  This will provide a detailed build log, which includes the full commands used by the build system to generate the :ref:`app_build_output_files`.
