    ...
    #. Replace AT parameter list initialization:
       ...
       * Add:
         ...
         .. note::
            ...
            Remember to check the returned error codes from the :ref:`at_parser_readme` functions. For simplicity's sake, they have been omitted from this migration guide. Please refer to the :ref:`at_parser_readme` documentation for more information on the API and the returned error codes.
