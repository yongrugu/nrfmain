...
The MCUboot fork in |NCS| (``sdk-mcuboot``) contains all commits from the upstream MCUboot repository up to and including :merge-base:`mcuboot:literal`, with some |NCS| specific additions.
...
The Zephyr fork in |NCS| (``sdk-zephyr``) contains all commits from the upstream Zephyr repository up to and including :merge-base:`zephyr:literal`, with some |NCS| specific additions.

For the list of upstream Zephyr commits (not including cherry-picked commits) incorporated into nRF Connect SDK since the most recent release, run the following command from the :file:`ncs/zephyr` repository (after running ``west update``):

.. parsed-literal::

   git log --oneline :merge-base-short:`zephyr` ^\ :previous-version-merge-base-short:`zephyr`

For the list of |NCS| specific commits, including commits cherry-picked from upstream, run:

.. parsed-literal::

   git log --oneline manifest-rev ^\ :merge-base-short:`zephyr`

The current |NCS| main branch is based on revision :merge-base-short:`zephyr:literal` of Zephyr.
