...
/** Request turning on or off the Fast Pair advertising.
 *
 ...
 *  the Fast Pair advertising will not be refreshed.
 *  Use the @ref app_fp_adv_refresh function to manually refresh the Fast Pair
 *  advertising.
 *
...
/** Refresh the Fast Pair advertising.
 *
