...
static void disconnected(struct bt_conn *conn, uint8_t reason)
{
	...
	fp_storage_ak_bond_conn_cancel(conn);
}
...
BUILD_ASSERT(CONFIG_BT_FAST_PAIR_BOND_MANAGER_INIT_PRIORITY <
	     CONFIG_BT_FAST_PAIR_STORAGE_INTEGRATION_INIT_PRIORITY);

FP_ACTIVATION_MODULE_REGISTER(fp_bond_manager, CONFIG_BT_FAST_PAIR_BOND_MANAGER_INIT_PRIORITY,
