...
/**
 * @defgroup fp_storage_ak_bond Fast Pair storage of associations between Account Keys and bonds
 * @brief Internal API for Fast Pair storage of associations between Account Keys and bonds
 *
...
/** Create and save Account Key association with the connected potential Bluetooth bond.
 *
 *  Used only when the CONFIG_BT_FAST_PAIR_STORAGE_AK_BOND Kconfig option is enabled.
 *
 *  The module links the Account Key information with the Bluetooth bond and stores
 *  it in the NVM memory. The association and the Bluetooth bond will be deleted if the bond is not
 *  confirmed using the @ref fp_storage_ak_bond_conn_confirm API before the bonding process is
 *  cancelled using the @ref fp_storage_ak_bond_conn_cancel API.
 *
 ...
 *  Used only when the CONFIG_BT_FAST_PAIR_STORAGE_AK_BOND Kconfig option is enabled.
 *
 *  It confirms the potential Bluetooth bond associated with the Account Key. The association should
 *  be earlier created using the @ref fp_storage_ak_bond_conn_create.
 *
...
/** Indicate that the bonding process has been cancelled.
 *
 *  Used only when the CONFIG_BT_FAST_PAIR_STORAGE_AK_BOND Kconfig option is enabled.
 *
 *  It relates to the Account Key association with the Bluetooth bond that was created
 *  earlier using the @ref fp_storage_ak_bond_conn_create.
 *
 * @param[in] conn_ctx Connection context associated with the Bluetooth bond.
 */
 ...
 *  Used only when the CONFIG_BT_FAST_PAIR_STORAGE_AK_BOND Kconfig option is enabled.
 *
 *  The association should be earlier created using the @ref fp_storage_ak_bond_conn_create.
 *
 * @param[in] conn_ctx Connection context associated with the Bluetooth bond.
 * @param[in] addr The Bluetooth address of the bond.
 */
 ...
 *  @ref fp_storage_init API if the CONFIG_BT_FAST_PAIR_STORAGE_AK_BOND Kconfig option is enabled.
 *
