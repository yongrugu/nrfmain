...
/** Settings key name prefix for bond info. */
#define SETTINGS_BOND_NAME_PREFIX "bond_info"
...
#endif
BUILD_ASSERT(FP_BONDS_ARRAY_LEN <= 100);
...
/** Full settings key name for Account Key owner (including subtree name). */
#define SETTINGS_OWNER_AK_NAME_SUFFIX	"0"
#define SETTINGS_OWNER_AK_NAME		SETTINGS_AK_NAME_PREFIX SETTINGS_OWNER_AK_NAME_SUFFIX
#define SETTINGS_OWNER_AK_FULL_NAME \
	(SETTINGS_AK_SUBTREE_NAME SETTINGS_NAME_SEPARATOR_STR SETTINGS_OWNER_AK_NAME)
...
#else
#define ACCOUNT_KEY_MAX_ID ACCOUNT_KEY_MIN_ID
#endif /* CONFIG_BT_FAST_PAIR_STORAGE_AK_BACKEND_STANDARD */
...
/** Bit 5: Owner field */
#define ACCOUNT_KEY_METADATA_OWNER_POS		(5UL)
#define ACCOUNT_KEY_METADATA_OWNER_MASK		(0x1UL << ACCOUNT_KEY_METADATA_OWNER_POS)

/** Bits 7..6: Reserved field */
#define ACCOUNT_KEY_METADATA_RESERVED_POS	(6UL)
#define ACCOUNT_KEY_METADATA_RESERVED_MASK	(0x3UL << ACCOUNT_KEY_METADATA_RESERVED_POS)
