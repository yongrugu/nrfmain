...
embedded_key embedded_keys[] = {
#ifdef EMBEDDED_KEY_OFFSET
	{0x4000BB00, EMBEDDED_KEY_OFFSET, 32,
	 PSA_KEY_TYPE_ECC_PUBLIC_KEY(PSA_ECC_FAMILY_TWISTED_EDWARDS), 255},
	{0x4000BB01, EMBEDDED_KEY_OFFSET + 32, 32,
	 PSA_KEY_TYPE_ECC_PUBLIC_KEY(PSA_ECC_FAMILY_TWISTED_EDWARDS), 255},
	{0x4000BB02, EMBEDDED_KEY_OFFSET + 64, 32,
	 PSA_KEY_TYPE_ECC_PUBLIC_KEY(PSA_ECC_FAMILY_TWISTED_EDWARDS), 255},
#endif
};
